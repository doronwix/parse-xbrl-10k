...
function loadRaw(xbrlDoc, fieldCount) {
      ...
      if (Array.isArray(nodeList)) {
        var attacheList = nodeList.map((node) => {
          ...
          if (
            node &&
            node.contextRef &&
            (node.contextRef === self.xbrl.fields["ContextForDurations"] ||
              node.contextRef === self.xbrl.fields["ContextForInstants"])
          ) {
            factNode = node;
          }
  ...
  console.log(
    "Entity registrant name: " + self.xbrl.fields["EntityRegistrantName"]
  );
  console.log("CIK: " + self.xbrl.fields["EntityCentralIndexKey"]);
  console.log(
    "Entity filer category: " + self.xbrl.fields["EntityFilerCategory"]
  );
  ...
  console.log(
    "Fiscal period: " + self.xbrl.fields["DocumentFiscalPeriodFocus"]
  );
  console.log("Document type: " + self.xbrl.fields["DocumentType"]);
  console.log(
    "Balance Sheet Date (document period end date): " +
      self.xbrl.fields["DocumentPeriodEndDate"]
  );
  console.log(
    "Income Statement Period (YTD, current period, period start date): " +
      self.xbrl.fields["IncomeStatementPeriodYTD"] +
      " to " +
      self.xbrl.fields["BalanceSheetDate"]
  );
  console.log(
    "Context ID for document period focus (instants): " +
      self.xbrl.fields["ContextForInstants"]
  );
  console.log(
    "Context ID for YTD period (durations): " +
...
function aggregate(nodeList) {
  if (nodeList["AssetsNoncurrent"] === null) {
    if (nodeList["Assets"] && nodeList["CurrentAssets"]) {
      nodeList["NoncurrentAssets"] =
        nodeList["Assets"] - nodeList["CurrentAssets"];
    } else {
  ...
  if (nodeList["LiabilitiesAndStockholdersEquity"] === null) {
    nodeList["LiabilitiesAndStockholdersEquity"] =
      nodeList["LiabilitiesAndPartnersCapital"];
...
function load(xbrlDoc) {
  ...
  self.xbrl.fields["Assets"] =
    self.xbrl.getFactValue("us-gaap:Assets", "Instant") || 0;

  // Current Assets
  self.xbrl.fields["CurrentAssets"] =
    self.xbrl.getFactValue("us-gaap:AssetsCurrent", "Instant") || 0;
  ...
  self.xbrl.fields["Liabilities"] =
    self.xbrl.getFactValue("us-gaap:Liabilities", "Instant") || 0;
  self.xbrl.fields["Liabilities"] =
    self.xbrl.fields["Liabilities"] < 0
      ? self.xbrl.fields["Liabilities"] * -1
      : self.xbrl.fields["Liabilities"];

  // CurrentLiabilities
  self.xbrl.fields["CurrentLiabilities"] =
    self.xbrl.getFactValue("us-gaap:LiabilitiesCurrent", "Instant") || 0;
  ...
  self.xbrl.fields["CommitmentsAndContingencies"] =
    self.xbrl.getFactValue("us-gaap:CommitmentsAndContingencies", "Instant") ||
    0;

  //new fields:
  // OperatingLeasesFutureMinimumPaymentsDueCurrent
  self.xbrl.fields["OperatingLeasesFutureMinimumPaymentsDueCurrent"] =
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["LongTermDebtFairValue"] =
    self.xbrl.getFactValue("us-gaap:LongTermDebtFairValue", "Instant") || 0;

  //InventoryWorkInProcess
  self.xbrl.fields["InventoryWorkInProcess"] =
    self.xbrl.getFactValue("us-gaap:InventoryWorkInProcess", "Instant") || 0;

  //RestrictedCashAndCashEquivalents
  self.xbrl.fields["RestrictedCashAndCashEquivalents"] =
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["CashAndCashEquivalents"] =
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["DepreciationAndAmortization"] =
    self.xbrl.getFactValue("us-gaap:DepreciationAndAmortization", "Instant") ||
    self.xbrl.getFactValue("us-gaap:DepreciationAndAmortization", "Duration") ||
    self.xbrl.getFactValue(
  ...
  if (self.xbrl.fields["TemporaryEquity"]) {
    self.xbrl.fields["TemporaryEquity"] =
      Number(self.xbrl.fields["TemporaryEquity"]) +
  ...
  self.xbrl.fields["Equity"] =
    ...
    self.xbrl.getFactValue("us-gaap:AssetsNet", "Instant") ||
    0;

  // EquityAttributableToNoncontrollingInterest
  self.xbrl.fields["EquityAttributableToNoncontrollingInterest"] =
    self.xbrl.getFactValue("us-gaap:MinorityInterest", "Instant") ||
    self.xbrl.getFactValue(
  ...
  if (
    ...
    self.xbrl.fields["LiabilitiesAndEquity"] !== 0 &&
    self.xbrl.fields["LiabilitiesAndEquity"] ===
      self.xbrl.fields["Liabilities"] + self.xbrl.fields["Equity"]
  ) {
    self.xbrl.fields["Assets"] = self.xbrl.fields["CurrentAssets"];
  }
  ...
  self.xbrl.fields["Revenues"] =
    self.xbrl.getFactValue("us-gaap:Revenues", DocBasedPeriod) ||
  ...
  self.xbrl.fields["CostOfRevenue"] =
    self.xbrl.getFactValue("us-gaap:CostOfRevenue", DocBasedPeriod) ||
    self.xbrl.getFactValue("us-gaap:CostOfServices", DocBasedPeriod) ||
    self.xbrl.getFactValue(
      "us-gaap:CostOfSellingGeneralAndAdministrativeExpenseGoodsSold",
      DocBasedPeriod
    ) ||
    self.xbrl.getFactValue(
  ...
  // Other fields
  self.xbrl.fields["RandDexpense"] =
    self.xbrl.getFactValue(
      "us-gaap:ResearchAndDevelopmentExpense",
      DocBasedPeriod
    ) || 0;
  self.xbrl.fields["SGandAexpenses"] =
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["OperatingIncome"] =
    self.xbrl.getFactValue("us-gaap:OperatingIncomeLoss", DocBasedPeriod) || 0;

  self.xbrl.fields["TaxPaid"] =
    self.xbrl.getFactValue("us-gaap:IncomeTaxesPaidNet", DocBasedPeriod) ||
    self.xbrl.getFactValue(
      "us-gaap:IncomeTaxExpenseBenefit ",
      DocBasedPeriod
    ) ||
    self.xbrl.getFactValue("us-gaap:IncomeTaxesPaid ", DocBasedPeriod) ||
    0;

  self.xbrl.fields["Capex"] =
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["InterestExpense"] =
    self.xbrl.getFactValue("us-gaap:InterestExpense", DocBasedPeriod) || 0;

  // GrossProfit
  self.xbrl.fields["GrossProfit"] =
    self.xbrl.getFactValue("us-gaap:GrossProfit", DocBasedPeriod) ||
    self.xbrl.getFactValue("us-gaap:GrossProfit", DocBasedPeriod) ||
    0;

  // OperatingExpenses
  self.xbrl.fields["OperatingExpenses"] =
    self.xbrl.getFactValue("us-gaap:OperatingExpenses", DocBasedPeriod) ||
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["CostsAndExpenses"] =
    self.xbrl.getFactValue("us-gaap:CostsAndExpenses", DocBasedPeriod) || 0;

  // OtherOperatingIncome
  self.xbrl.fields["OtherOperatingIncome"] =
    self.xbrl.getFactValue("us-gaap:OtherOperatingIncome", DocBasedPeriod) ||
    self.xbrl.getFactValue("us-gaap:OtherOperatingIncome", DocBasedPeriod) ||
    0;

  //outstading shares
  self.xbrl.fields["NumberOfSharesOutstanding"] =
    self.xbrl.getFactValue(
      "us-gaap:WeightedAverageNumberOfDilutedSharesOutstanding",
      DocBasedPeriod
    ) ||
    self.xbrl.getFactValue("us-gaap:CommonStockSharesOutstanding", "Instant") ||
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["OperatingIncomeLoss"] =
    self.xbrl.getFactValue("us-gaap:OperatingIncomeLoss", DocBasedPeriod) ||
    self.xbrl.getFactValue("us-gaap:OperatingIncomeLoss", DocBasedPeriod) ||
    0;
  ...
  self.xbrl.fields["InterestAndDebtExpense"] =
    self.xbrl.getFactValue("us-gaap:InterestAndDebtExpense", DocBasedPeriod) ||
    self.xbrl.getFactValue("us-gaap:InterestAndDebtExpense", DocBasedPeriod) ||
    0;
  ...
  self.xbrl.fields["IncomeTaxExpenseBenefit"] =
    self.xbrl.getFactValue("us-gaap:IncomeTaxExpenseBenefit", DocBasedPeriod) ||
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["NetIncomeLoss"] =
    self.xbrl.getFactValue("us-gaap:ProfitLoss", DocBasedPeriod) ||
  ...
  //dividend
  self.xbrl.fields["PaymentsOfDividendsCommonStock"] =
    self.xbrl.getFactValue(
  ...
  self.xbrl.fields["AccountsReceivable"] =
    self.xbrl.getFactValue("us-gaap:AccountsReceivableNetCurrent", "Instant") ||
    0;

  //Inventories
  self.xbrl.fields["Inventories"] =
    self.xbrl.getFactValue("us-gaap:InventoryNet", "Instant") ||
    self.xbrl.getFactValue("us-gaap:InventoryGross", "Instant") ||
    0;

  //AccountsPayableCurrent
  self.xbrl.fields["AccountsPayable"] =
    self.xbrl.getFactValue("us-gaap:AccountsPayableCurrent", "Instant") || 0;
  ...
  self.xbrl.fields["NetIncomeAttributableToParent"] =
    self.xbrl.getFactValue("us-gaap:NetIncomeLoss", DocBasedPeriod) || 0;

  //Depreciation
  self.xbrl.fields["Depreciation"] =
    self.xbrl.getFactValue("us-gaap:Depreciation", DocBasedPeriod) || 0;

  //AmortizationOfIntangibleAssets
  self.xbrl.fields["AmortizationOfIntangibleAssets"] =
    self.xbrl.getFactValue(
  ...
  //Acquisitions
  self.xbrl.fields["Acquisitions"] =
    self.xbrl.getFactValue(
      "us-gaap:PaymentsToAcquireBusinessesNetOfCashAcquired",
      DocBasedPeriod
    ) ||
    self.xbrl.getFactValue(
      "us-gaap:DeferredPolicyAcquisitionCostsAndValueOfBusinessAcquiredAbstract",
      DocBasedPeriod
    ) ||
    self.xbrl.getFactValue(
  ...
  if (
    self.xbrl.fields["DepreciationAndAmortization"] === 0 &&
    self.xbrl.fields["Depreciation"] !== 0 &&
    self.xbrl.fields["AmortizationOfIntangibleAssets"] !== 0
  ) {
    self.xbrl.fields["DepreciationAndAmortization"] =
      self.xbrl.fields["Depreciation"] +
      self.xbrl.fields["AmortizationOfIntangibleAssets"];
  ...
  if (
    ...
    self.xbrl.fields["GrossProfit"] =
      self.xbrl.fields["Revenues"] - self.xbrl.fields["CostOfRevenue"];
  }
  ...
  if (
    ...
    self.xbrl.fields["Revenues"] =
      self.xbrl.fields["GrossProfit"] + self.xbrl.fields["CostOfRevenue"];
  }
  ...
  if (
    ...
    self.xbrl.fields["OperatingExpenses"] =
      self.xbrl.fields["GrossProfit"] - self.xbrl.fields["OperatingIncomeLoss"];
  }
  ...
  if (
    ...
    self.xbrl.fields["CostsAndExpenses"] =
      self.xbrl.fields["CostOfRevenue"] + self.xbrl.fields["OperatingExpenses"];
  }
  ...
  //calculated: OperatingMargin
  self.xbrl.fields["OperatingMargin"] =
    self.xbrl.fields["OperatingIncome"] / self.xbrl.fields["Revenues"];
  //calculated: TaxRate
  self.xbrl.fields["TaxRate"] =
    self.xbrl.fields["TaxPaid"] / self.xbrl.fields["OperatingIncome"];
  //calculated: DAMargin
  if (self.xbrl.fields["DepreciationAndAmortization"] !== 0) {
    self.xbrl.fields["DAMargin"] =
      self.xbrl.fields["DepreciationAndAmortization"] /
      self.xbrl.fields["Revenue"];
  } else {
    self.xbrl.fields["DAMargin"] = 0;
  }
  //calculated: CapexMargin
  self.xbrl.fields["CapexMargin"] =
    self.xbrl.fields["Capex"] / self.xbrl.fields["Revenue"];
  //calculated: AcquisitionMargin
  self.xbrl.fields["AcquisitionMargin"] =
    self.xbrl.fields["Acquisition"] / self.xbrl.fields["Revenue"];
  //calculated: Edbita

  self.xbrl.fields["Ebitda"] =
    self.xbrl.fields["NetIncomeLoss"] +
    self.xbrl.fields["DepreciationAndAmortization"] +
    self.xbrl.fields["TaxPaid"] +
    self.xbrl.fields["InterestAndDebtExpense"];

  //calculated: WorkingCapital
  self.xbrl.fields["WorkingCapital"] =
    self.xbrl.fields["CurrentAssets"] - self.xbrl.fields["CurrentLiabilities"];
  self.xbrl.fields["WorkingCapitalMMargin"] =
    self.xbrl.fields["WorkingCapital"] / self.xbrl.fields["Revenue"];
  self.xbrl.fields["WorkingCapitalPerRevenues"] =
    self.xbrl.fields["WorkingCapital"] / self.xbrl.fields["Revenues"];
  ...
  self.xbrl.fields["NetCashFlowsContinuing"] =
    self.xbrl.fields["NetCashFlowsOperatingContinuing"] +
    self.xbrl.fields["NetCashFlowsInvestingContinuing"] +
    self.xbrl.fields["NetCashFlowsFinancingContinuing"];

  //calculated: FCF
  self.xbrl.fields["FCF"] =
    self.xbrl.fields["NetCashFlowsOperating"] -
    self.xbrl.fields["Capex"] -
    self.xbrl.fields["PaymentsOfDividendsCommonStock"];
  ...
  self.xbrl.fields["SGR"] =
    ((self.xbrl.fields["NetIncomeLoss"] / self.xbrl.fields["Revenues"]) *
      (1 +
      ...
      (1 / (self.xbrl.fields["Revenues"] / self.xbrl.fields["Assets"]) -
        (self.xbrl.fields["NetIncomeLoss"] / self.xbrl.fields["Revenues"]) *
          (1 +
            (self.xbrl.fields["Assets"] - self.xbrl.fields["Equity"]) /
              self.xbrl.fields["Equity"])) || null;

  self.xbrl.fields["ROA"] =
    self.xbrl.fields["NetIncomeLoss"] / self.xbrl.fields["Assets"];

  self.xbrl.fields["ROE"] =
    self.xbrl.fields["NetIncomeLoss"] / self.xbrl.fields["Equity"];
