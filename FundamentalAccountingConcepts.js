...
function load(xbrlDoc) {
 ...
 self.xbrl.getFactValue("us-gaap:SellingAndMarketingExpense", "Duration") +
 self.xbrl.getFactValue("us-gaap:GeneralAndAdministrativeExpense", "Duration") || 0;
 ...
 self.xbrl.getFactValue("us-gaap:DepreciationAmortizationAndAccretionNet ", "Duration") ||
 self.xbrl.getFactValue("us-gaap:DepreciationDepletionAndAmortization ", "Duration") || 0;
 ...
 // CostsAndExpenses
 self.xbrl.fields['CostsAndExpenses'] = self.xbrl.getFactValue("us-gaap:CostsAndExpenses", "Duration") || 0;
